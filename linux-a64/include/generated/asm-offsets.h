...
#define VCPU_IRQ_LINES 2448 /* offsetof(struct kvm_vcpu, arch.irq_lines)	// */
...
#define KVM_TIMER_CNTVOFF 856 /* offsetof(struct kvm, arch.timer.cntvoff)	// */
#define KVM_TIMER_ENABLED 848 /* offsetof(struct kvm, arch.timer.enabled)	// */
...
#define KVM_VTTBR 648 /* offsetof(struct kvm, arch.vttbr)	// */
#define KVM_VGIC_VCTRL 672 /* offsetof(struct kvm, arch.vgic.vctrl_base)	// */
